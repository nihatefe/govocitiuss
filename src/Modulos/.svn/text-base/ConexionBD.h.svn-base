 ...
 */
	...
	class ConexionBD
	{
		public:
			...
			bool descargarFicherosClasificador(vector<string> &especie, HttpsConexion *conex);
			bool enviaFicherosClasificador(const string &especie, const string *fich, SftpConexion *conex);
			...
			bool consultaEspecies(vector<string> &especies);
			bool consultaIndividuosEspecie(string especie, vector<string> &individuosEspecie);
			bool consultaImagenesEspecie(string especie, vector<string> &imagen, vector<string> &ficheroXML);
