...
#ifndef _VENTANASELECCIONESPECIE_H_
#define _VENTANASELECCIONESPECIE_H_
...
struct datosGestorCancelarEspecies {
  GtkWidget *ventanaEspecies;	
  gint cancelar;
};
...
#endif // _VENTANASELECCIONESPECIE_H_
