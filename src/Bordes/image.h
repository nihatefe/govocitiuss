...
int point_inside(PointList * list, Point * p);
...
/* texture.c */
double * textureLBPColor(const Image *img,  PointList * in);
...
/* scan_fill.c */
double computeRoundness(PointList * in, int num_rows, int num_cols);
