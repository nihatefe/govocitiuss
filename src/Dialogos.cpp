...
/**
 Metodo estatico que muesta un Dialogo de informacion
 @param t, string que contiene el texto del dialogo.
 @param tittle, string que contiene el titulo del dialogo.
 */
void Dialogos::dialogoInformacion(const string &t, const string &title)
{
	Gtk::MessageDialog dialogoConf(t, false, Gtk::MESSAGE_INFO, Gtk::BUTTONS_OK, false);

	dialogoConf.set_icon_from_file(Utiles::getIconoFile("informacion.png"));
	dialogoConf.set_title(title);
