...
{	
	Utiles::getWidgetGlade(Utiles::getGladeFile("PanelPropiedades.glade"), "panDer", 
	                       ...
	                       "selectAllG2", &selectAllG2,
	                       "NotUseAreaG", &NotUseAreaG,
	                       "NotUseAreaG2", &NotUseAreaG2,
...
bool PanelPropiedades::getDrawcircle()
{
	return Drawcircle->get_active();
}
/**
 Devuelve verdadero si esta activado el atributo, falso en caso contrario.
 @return bool.
...
bool PanelPropiedades::getSelecCel2()
{
	return SelecCel2->get_active();
}
...
bool PanelPropiedades::getNotUseAreaImage2()
{
	return NotUseAreaG2->get_active();
}
...
void PanelPropiedades::setSensitiveSelecCel2(bool s)
{
	SelecCel2->set_sensitive(s);
}
...
void PanelPropiedades::setSensitiveEliminaCelula2(bool s)
{
	EliminaCelula2->set_sensitive(s);
}
...
void PanelPropiedades::setSensitiveDrawcircle(bool s)
{
	Drawcircle->set_sensitive(s);
}
/**
 Hace sensible el atributo.
 @param s, bool.
...
void PanelPropiedades::setSensitiveCalcDiam2(bool c)
{
	calcDiamet2->set_sensitive(c);
}
...
void PanelPropiedades::setSentiviePrintData2(bool c)
{
	printDataG2->set_sensitive(c);
}
...
void PanelPropiedades::setActiveSelec2(bool s)
{
	SelecCel2->set_active(s);
}
...
{	
	...
	else if(blocNotas->get_current_page() == 3)
	{
		if(Drawcircle->get_active())
		{
			
		EliminaCelula->set_sensitive(false);
		}
		if(SelecCel2->get_active())
		{
		...
		else if(NotUseAreaG2->get_active())
		{
			//Hacemos no sensibles
			/*AnhadirCelManoAL->set_sensitive(false);
			AnhadirCelPT->set_sensitive(false);
...
void PanelPropiedades::activaCapaCelulas()
{
	if((activCapaCelE->get_active() && blocNotas->get_current_page() == 0) ||
	   (activCapaCelR->get_active() && blocNotas->get_current_page() == 1) || (activCapaCelE2->get_active() && blocNotas->get_current_page() == 3) )
	{
