 ...
 */
	...
	class PanelPropiedades : public Gtk::ScrolledWindow
	{
		public:
			...
			void setSensitiveCalcDiam2(bool);
			void setSentiviePrintData(bool c);
			void setSentiviePrintData2(bool c);
		...
		private:
			...
			*calcDiamet, *calcEstadist, *confRej, *calcTodosDiam, *printDataG, *printDataG1, *EliminaCelula2, *selectAllG2, *calcTodosDiam2, *calcDiamet2, *printDataG2;
			Gtk::CheckButton *activCapaCelE,*activCapaCelR, *activaCapaRejR, *activaBordeRejR, *activCapaCelE2;
			Gtk::Label *panelP;
			Gtk::Label *nFilasR, *nColR, *nPunR, *separR;
			Gtk::RadioButton *AnhadirCel, *ModifCel, *AnhadirCelManoAL, *Drawcircle, *AnhadirCelPT,
			*SelecCel, *rejillaDefec, *rejillaPersonal, *SelecCel2;
			...
			Gtk::RadioButton *ModifCelNSup, *AnhadirCelManoALNSup, *AnhadirCelPTNSup, *SelecCelNSup, *NotUseAreaG, *NotUseAreaG2;
			double micras;
